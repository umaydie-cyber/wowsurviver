...
- 开局职业四选一：狂暴战士、冰霜法师、火焰法师和兽王猎人，分别以旋风斩、寒冰箭、火球术和杀戮命令开局
- 开局先选择 1–5 难度，分别按 20%、40%、60%、75%、90% 的技能命中率目标平衡敌人生命与伤害
- 波次商店提高了道具价格，购买后会立即为该货位刷新新道具
- 狂战士“狂怒”玩法：旋风斩、致死打击、嗜血与斩杀均会自动释放；嗜血概率回复生命，斩杀会依据低血量目标已损失生命提高伤害
- 野狼追击、接触伤害、经验球和等级成长
- 升级暂停与四选一天赋：范围、持续时间、双斧、吸血、命中延时及永久旋转顶点会实际改变技能机制
- 法师和猎人拥有各自的伤害、施法频率、控制、多重弹道与顶点成长词条；升级选择已增加重入保护与明确点击反馈
